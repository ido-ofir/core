...
var core = window.core = new Core({
    ...
    plugins: [
      ...
      require('./core_plugins/core.uuid'),      
      ...
      require('./core_plugins/core.imports.react'),
      require('./core_plugins/core.imports.create-react-class'),
      require('./core_plugins/core.imports.prop-types'),
      require('./core_plugins/core.imports.baobab'),
      require('./core_plugins/core.imports.q'),
      ...
      require('./core_plugins/core.bequeath'),
      require('./core_plugins/core.mapTypes'),
      ...
      require('./core_plugins/core.dox'),
      require('./core_plugins/core.list'),
    ]
});
