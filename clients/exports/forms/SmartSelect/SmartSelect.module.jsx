...
core.Component('forms.Select', ['forms.input.mixin'], (inputMixin)=> {
    ...
    if(!inputStyle.position) inputStyle.position = 'relative'
     ...
     return (
      <div style={ this.props.inputStyle }>
        <span className="SmartSelect-label" style={{ ...labelStyle, ...props.labelStyle }}>{this.props.label}</span>
        <div className={ `SmartSelect-selectwrap ${this.state.className}` } style={this.props.style} >
          <Select
